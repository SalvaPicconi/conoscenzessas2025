...
(function () {
    ...
    function contenutoPannello(voce) {
        ...
        return `
            ...
            <p class="norma-pop-vai"><a href="normativa.html#${esc(voce.id)}" target="_top">Apri il glossario normativo →</a></p>`;
    }
    ...
    function avvia() {
        ...
        // I tre cataloghi ridisegnano le schede a ogni filtro: i segni vanno
        ...
        // votazione, ripartizione oraria e revisione: si marca quando hanno
