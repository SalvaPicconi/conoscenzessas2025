...
- **UDA d'asse unificate** — 27 schede proposte per il dipartimento nella navigazione principale. Le 48 schede precedenti restano come catalogo storico, raggiungibile dalla proposta ma non esposto come percorso parallelo. Le indicazioni della Prof.ssa Manca, le attribuzioni integrative di Metodologie operative e i relativi effetti sulle ore sono documentati nel [registro del 7 settembre](revisioni/2026-09-07-indicazioni-manca/REGISTRO.md).
