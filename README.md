...
- **UDA scelte dal Dipartimento** — quadro autonomo e modificabile delle decisioni del 9 settembre 2026: due UDA adottate nel biennio, tre UDA FSL e tre UDA d'asse nel triennio, più due simulazioni della seconda prova in quinta. Le revisioni usano chiavi proprie della sezione e non modificano automaticamente le UDA originali richiamate. La pagina distingue conferme, titoli ancora da definire e dati non reperiti; segnala inoltre la necessaria integrazione di “Parole che curano · Salute mentale” nel verbale finale.
...
- `uda-dipartimento.html` + `uda-dipartimento.js` + `uda-dipartimento.css` + `data-uda-dipartimento.json` — sintesi tracciata delle UDA scelte dal Dipartimento e delle due simulazioni previste per la quinta
...
- `supabase/consenti-uda-dipartimento.sql` — migrazione che abilita le chiavi autonome della sintesi dipartimentale senza riutilizzare le chiavi delle UDA originali
